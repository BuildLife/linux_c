...
/*TFTP[0~5] --> arp gets tftp server mac
  ...
  start 31 30 6b 2e 63 66 67 00 end*/
/*Checksum(Identification) : 0x0006*/

char tftpPacket_docsis[] = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c,
0x7b, 0x11, 0x00, 0x00, 0x08, 0x00, 0x45, 0x00,
...
/*Emta files eusip_4000.bin
  ...
  start 65 75 73 69 70 5f 34 30 30 30 2e 62 69 6e 00 end*/
/*Checksum(Identification) : 0x0017*/

char tftpPacket_emta[] = {
0xc4, 0x12, 0xf5, 0x30, 0x92, 0xf9, 0x00, 0x1c,
0x7b, 0x22, 0x22, 0x23, 0x08, 0x00, 0x45, 0x00,
...
/*For LAN TFTP buffer*/
//eth_header *LAN_tftp_ethhdr = (eth_header*)tftpPacket_docsis;

/*For LAN TFTP buffer*/
//eth_header *LAN_tftp_ethhdr = (eth_header*)tftpPacket_emta;
